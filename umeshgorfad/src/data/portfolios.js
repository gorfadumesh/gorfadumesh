export const portfolios = {
  Web: [
    ...
    {
      type: "featured",
      name: "js.umeshgorfad.netlify.app",
      image: require("./image/js.umeshgorfad.netlify.app.png"),
      description:
        "Learn Practical use case of JavaScript in your everyday life, entirely in Bengali",
      demo: "https://umesh.js.org",
      source: "https://github.com/zonayedpca/js.umeshgorfad.netlify.app",
    ...
    },
    {
      ...
      source: "https://github.com/zonayedpca/old.js.umeshgorfad.netlify.app",
      tools: ["react", "pwa"],
    },
  ],
  Others: [
